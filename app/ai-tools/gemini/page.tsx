...
export const metadata: Metadata = {
  title: "Google Gemini",
  description:
    "Learn about Google Gemini, an AI assistant for research, writing, ideas, and productivity.",
};
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8 md:p-12">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-400">
            Google Gemini is an AI assistant that can help with research,
            writing, ideas, learning, and everyday productivity.
          </p>
          ...
          <div className="mt-12 border-t border-slate-800 pt-8">
            <h2 className="text-2xl font-bold">
              What can Google Gemini help with?
            </h2>
            ...
            <ul className="mt-5 space-y-3 text-slate-400">
              ...
              <li>• Ideas and creative tasks</li>
