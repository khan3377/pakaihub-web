...
export const metadata: Metadata = {
  title: "Runway AI",
  description:
    "Learn about Runway, an AI-powered platform for generating and editing videos and creative media.",
};
      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-8 md:p-12">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-400">
            Runway is an AI-powered platform for generating and editing
            videos, images, and other creative media.
          </p>
          ...
          <div className="mt-12 border-t border-slate-800 pt-8">
            ...
            <ul className="mt-5 space-y-3 text-slate-400">
              ...
              <li>• Visual effects and experiments</li>
