      ...
      <section className="mx-auto max-w-4xl px-6 py-20">
        <div className="text-center">
          ...
          <p className="mx-auto mt-6 max-w-2xl text-lg leading-8 text-slate-400">
            Mistral AI is useful for writing, research, coding, analysis,
            and productivity.
          </p>
        ...
        <div className="mt-14 rounded-2xl border border-slate-800 bg-slate-900 p-8">
          ...
          <p className="mt-4 leading-8 text-slate-400">
            Mistral AI provides AI models and tools that can help with
            questions, writing, coding, research, and other everyday tasks.
          </p>
        </div>
      </section>
